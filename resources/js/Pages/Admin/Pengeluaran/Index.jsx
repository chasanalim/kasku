...
export default function Index({ title, flash, infaq, can }) {
    ...
    const handleMultipleVerify = () => {
        ...
        router.post(
            route("admin.pengeluaran.verify-multiple"),
            {
                ids: selectedIds,
            },
            {
    ...
    const handleMultipleDelete = () => {
        ...
        router.delete(route("admin.pengeluaran.destroy-multiple"), {
    ...
    useEffect(() => {
        const dt = $(tableRef.current).DataTable({
            ...
            ajax: {
                url: route("admin.pengeluaran.index"),
                type: "GET",
                data: (d) => {
                        ...
                        <div className="card">
                            <div className="card-header pb-0 d-flex justify-content-between align-items-center">
                                ...
                                {can.createPengeluaran && (
                                    <Link
                                        href={route("admin.pengeluaran.create")}
